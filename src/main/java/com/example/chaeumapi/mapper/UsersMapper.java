...
public interface UsersMapper {
    ...
    int insertUsers(@Param("c_name") String c_name, @Param("c_id") String c_id, @Param("c_pw") String c_pw, @Param("c_date") Date c_date);

    @Update("UPDATE Users SET c_name=#{c_name}, c_pw=#{c_pw} WHERE c_id=#{c_id}")
    int updateUsers(String c_name, String c_id, String c_pw, Date c_date);
